    ...
    "paths": {
        ...
        "/api/users/signUp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Phone and optional SMS code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.VerifyIdentityRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.MessageResponse": {
            ...
            "properties": {
                "message": {
                    "type": "string",
                    "example": "registration code sent"
                }
            }
        },
        "models.PayRequest": {
